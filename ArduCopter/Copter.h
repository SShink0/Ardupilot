...
# include USERHOOK_VARIABLES
    ...
    void Log_Write_SysID_Setup(uint8_t systemID_axis, float _waveform_magnitude, float frequency_start, float frequency_stop, float time_fade_in, float time_const_freq, float time_record, float time_fade_out);
