...
void RC_Channels_Copter::save_trim()
{
    ...
    const float roll_trim = ToRad((float)copter.channel_roll->get_control_in()/100.0f);
    const float pitch_trim = ToRad((float)copter.channel_pitch->get_control_in()/100.0f);
