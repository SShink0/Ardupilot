...
ModeRTL::RTLAltType ModeRTL::get_alt_type() const
{
    ...
    case RTLAltType::RTL_ALTTYPE_RELATIVE ... RTLAltType::RTL_ALTTYPE_ABSOLUTE:
...
void ModeRTL::compute_return_target()
{
    ...
    if (get_alt_type() == RTLAltType::RTL_ALTTYPE_ABSOLUTE) {
    ...
    if (g.rtl_cone_slope >= RTL_MIN_CONE_SLOPE) {
        target_alt = MAX(curr_alt, MIN(target_alt, MAX(rtl_cone_height, curr_alt+RTL_ABS_MIN_CLIMB)));
    }
