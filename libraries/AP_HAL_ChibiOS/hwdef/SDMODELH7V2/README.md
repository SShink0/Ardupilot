...
The SDMODEL SDH7 V2 supports OSD using OSD_TYPE 1 (MAX7456 driver).

## PWM Output

The SDMODEL SDH7 V2 supports up to 9 PWM outputs. The pads for motor output
