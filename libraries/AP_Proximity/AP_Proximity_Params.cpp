...
const AP_Param::GroupInfo AP_Proximity_Params::var_info[] = {
    ...
    // @Values: 0:None,7:LightwareSF40c,2:MAVLink,3:TeraRangerTower,4:RangeFinder,5:RPLidarA2,6:TeraRangerHub,8:LightwareSF45B,10:SITL,12:AirSimSITL,13:CygbotD1, 14:DroneCAN
    // @RebootRequired: True
    // @User: Standard
