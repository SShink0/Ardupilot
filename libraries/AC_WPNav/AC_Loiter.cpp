...
const AP_Param::GroupInfo AC_Loiter::var_info[] = {
    ...
    // @Description{Copter, Heli, Sub}: Loiter maximum pilot requested lean angle. Set to zero for 2/3 of PSC_ANGLE_MAX/ANGLE_MAX. The maximum vehicle lean angle is still limited by PSC_ANGLE_MAX/ANGLE_MAX
