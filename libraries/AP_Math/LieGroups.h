...
class GL2 {
    ...
    static GL2 identity() { return GL2(1.,0.,0.,1.); };
    static GL2 exponential(const GL2& S);

    const ftype& a11() const { return _a11; }
    const ftype& a12() const { return _a12; }
    const ftype& a21() const { return _a21; }
    const ftype& a22() const { return _a22; }
...
public:
    ...
    Matrix3F& rot() { return _rot; }
    const Matrix3F& rot() const { return _rot; }
    const Vector3F& pos() const { return _pos; }
    const Vector3F& vel() const { return _vel; }
    ftype tau() const { return _tau; }
...
class SIM23 {
    ...
    const Vector3F & W1() const {return _W1; }
    const Vector3F & W2() const {return _W2; }
    const GL2& A() const {return _A; }
    Matrix3F& R() {return _R; }
    Vector3F & W1() {return _W1; }
    Vector3F & W2() {return _W2; }
    GL2& A() {return _A; }
