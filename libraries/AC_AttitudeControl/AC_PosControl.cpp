...
void AC_PosControl::update_xy_controller()
{
    ...
    Vector2f accel_target = _pid_vel_xy.update_all(Vector2f{_vel_target.x, _vel_target.y}, Vector2f{_inav.get_velocity().x, _inav.get_velocity().y}, Vector2f{_limit_vector.x, _limit_vector.y});
